...
urlpatterns = [
    ...
    path(
        "api/courses/update/<int:course_id>/",
        update_course_api,
        name="update_course_api",
    ),
    path(
        "api/courses/delete/<int:course_id>/",
        delete_course_api,
        name="delete_course_api",
    ),
    ...
    path(
        "api/teachers/update/<int:teacher_id>/",
        update_teacher_api,
        name="update_teacher_api",
    ),
    path(
        "api/teachers/delete/<int:teacher_id>/",
        delete_teacher_api,
        name="delete_teacher_api",
    ),
